...
uint8_t cache[270*1024]; //128 KB cache
uint32_t cache_addr=(uint32_t)cache;
static TouchGFXHAL hal(dma, display, tc, 800, 480);

ManyBlockAllocator<24000,4,2> frameBufferAllocator;
...
void touchgfx_init()
{
 // Bitmap::registerBitmapDatabase(BitmapDatabase::getInstance(), BitmapDatabase::getInstanceSize());
  Bitmap::registerBitmapDatabase(BitmapDatabase::getInstance(), BitmapDatabase::getInstanceSize(),(uint16_t*)cache, sizeof(cache),1);
