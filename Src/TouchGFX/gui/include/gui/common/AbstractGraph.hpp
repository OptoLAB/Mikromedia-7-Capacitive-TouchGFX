...
public:
     ...
     * @param newRight  The x value at the right of the graph area.
     * @param newBottom The y value at the bottom of the graph area.
     * @param newTop    The y value at the top of the graph area.
     */
    void setRange(int newLeft, int newRight, int newBottom, int newTop);

    /**
     * @fn int AbstractGraph::getRangeLeft()
     *
