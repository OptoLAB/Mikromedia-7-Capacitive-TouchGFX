...
// CE (chip enable) pin
#define nRF24_CE_PORT			GPIOJ
#define nRF24_CE_PIN			GPIO_PIN_8
// CSN (chip select negative) pin
#define nRF24_CSN_PORT			GPIOD
#define nRF24_CSN_PIN			GPIO_PIN_2
// IRQ pin
#define nRF24_IRQ_POR			GPIOD
#define nRF24_IRQ_PIN			GPIO_PIN_3

#define nRF24_CSN_H             nRF24_CSN_PORT->BSRR = nRF24_CSN_PIN
#define nRF24_CSN_L             nRF24_CSN_PORT->BSRR = (uint32_t)nRF24_CSN_PIN << 16
#define nRF24_CE_H				nRF24_CE_PORT->BSRR = nRF24_CE_PIN
#define nRF24_CE_L              nRF24_CE_PORT->BSRR = (uint32_t)nRF24_CE_PIN << 16

#define nRF24_BAUDRATEPRESCALER		SPI_BAUDRATEPRESCALER_8 //there are other modules on spi which can perform faster
